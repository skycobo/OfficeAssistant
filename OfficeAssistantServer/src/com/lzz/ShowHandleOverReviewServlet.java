...
/**
 * Servlet implementation class ShowHandleOverReviewServlet
 */
@WebServlet("/ShowHandleOverReview")
public class ShowHandleOverReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowHandleOverReviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultSet rs = Mysql.query("select * from review where handler='"+handler+"' and status !='"+status+"';");
		try {
			if(rs.next()){
